...
#
# Note also that gen-readme.sh assumes that any command line starting
# with "./" (to run an executable in current directory) is running a
# executable *generated by diderotc*; these are the commands for which
# it would be useful to prefix something else for testing (like valgrind
# or a timing command)
#
